...
Tr::Translation TREEVIEW_WAITING_STATUS              = Tr::translate("MainWindow", "Waiting...");
Tr::Translation TREEVIEW_WAITING_STATUS_SEC          = Tr::translate("MainWindow", "Waiting (%1 sec.)");
