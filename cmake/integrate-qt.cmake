...
macro(QT_ADD_POSTBUILD_STEP TARGET_NAME libLocation copyToSubdirectory)
	...
	set(DEBUG_REPLACE_PATTERN "/bin/([^/]+)$" "/debug/bin/\\1")
	string(REGEX REPLACE ${DEBUG_REPLACE_PATTERN} libLocation_debug_candidate ${libLocation_release})
	set(DEBUG_PLUGINS_REPLACE_PATTERN "/plugins/" "/debug/plugins/")
	string(REGEX REPLACE ${DEBUG_PLUGINS_REPLACE_PATTERN} libLocation_debug_candidate ${libLocation_debug_candidate})

	if(WIN32)
		string(REGEX REPLACE ".dll" "d.dll" libLocation_debug ${libLocation_debug_candidate})
	elseif(APPLE)
		string(REGEX REPLACE ".dylib" "d.dylib" libLocation_debug ${libLocation_debug_candidate})
	else()
		string(REGEX REPLACE ".so" "d.so" libLocation_debug ${libLocation_debug_candidate})
	endif()

	if(NOT EXISTS "${libLocation_debug}")	
		if(WIN32)
